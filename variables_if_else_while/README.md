...
This project is about using arithmetic, logical, relational, and boolean operators in C. Additionally, there's practise declaring and defining variables of type
